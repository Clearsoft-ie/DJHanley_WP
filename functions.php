...
if ( ! function_exists( 'DJHanley_setup' ) ) {

	function DJHanley_setup() {
		...
		// Custom Image Sizes
		add_image_size( 'DJHanley_fullscreen', 1860, 9999 );
...
//		add_editor_style('/assets/css/cocoen.min.css');
		...
		register_nav_menu( 'Services-menu', __( 'Services Menu', 'Services' ) );
		register_nav_menu( 'Site-Links-menu', __( 'Site Links Menu', 'Site-Link' ) );
		...
		load_theme_textdomain( 'DJHanley', get_template_directory() . '/languages' );
		
		
		wp_enqueue_style( 'DJHanley-style', get_template_directory_uri() . '/style.css', $dependencies );

	}
	add_action( 'after_setup_theme', 'DJHanley_setup' );
