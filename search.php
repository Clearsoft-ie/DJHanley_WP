...
?>
<h2 style='font-weight:bold;color:#000;padding-left: 40px;'>No Results Found for : <span>".get_query_var('s')."</span></h2>
<div style='padding-left: 40px;' class="alert alert-info">
