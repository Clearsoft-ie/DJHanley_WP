...
*************************************************** **/
	...
	function ClearsoftCustomJS() {
		$( '#topMain>li>a:contains("CONTACT")').wrapInner('<span class="menu-btn-navy hidden-md-down"></span>');
		$( '#topMain>li>a:contains("CONTACT")').append('<spam class="hidden-md-up">CONTACT</spam>');
		$('#topMain>li').removeAttr('class');
		$('#topMain li:has(ul)').attr('class')
		$('#topMain li:has(ul)').addClass('dropdown');
		$('.dropdown a[href*="#"]').attr('class')
		$('.dropdown a[href*="#"]').addClass('dropdown-toggle');
		$('#ServicesMenu>li').removeClass();
		$('#ServicesMenu>li>a').attr('class');
		$('#ServicesMenu>li>a').addClass('block');
		$('#ServicesMenu>li>a').prepend('<i class="fa fa-angle-right"></i>');
		$('#SiteLinksMenu>li').removeClass();
		$('#SiteLinksMenu>li>a').prepend('<i class="fa fa-angle-right"></i>');
		$('#SiteLinksMenu>li>a').attr('class');
		$('#SiteLinksMenu>li>a').addClass('block');
	}
	...
	function _topNav() {
		...
		jQuery(window).scroll(function() {
			...
			if(window.width < 769) {
				...
				if(jQuery('#header li.search .search-box').is(":visible") && originalSize == currentSize) {
